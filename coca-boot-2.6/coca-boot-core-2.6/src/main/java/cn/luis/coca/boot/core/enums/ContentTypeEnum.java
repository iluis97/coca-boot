...
public enum ContentTypeEnum {
     ...
     * @return ContentType
     */
    public static String matchContentType(String fileName) {
        //截取后缀
        int index = Objects.requireNonNull(fileName).lastIndexOf(".");
        String fileSuffix = fileName.substring(index);
        return suffix(fileSuffix).getType();
    }

    public static ContentTypeEnum suffix(String fileSuffix) {
        return Arrays.stream(ContentTypeEnum.values())
                .filter(e -> fileSuffix.equalsIgnoreCase(e.getSuffix()))
                .findAny()
                .orElseThrow(() -> new RuntimeException("not found ContentTypeEnum"));
    }

    public static ContentTypeEnum contentType(String contentType) {
        return Arrays.stream(ContentTypeEnum.values())
                .filter(e -> contentType.equalsIgnoreCase(e.getType()))
                .findAny()
                .orElseThrow(() -> new RuntimeException("not found ContentTypeEnum"));
    }
